        ...
        <div class="px-20 py-12 max-w-full max-h-full">
            ...
            <div class="w-full  bg-dark-foreground rounded-md">
                <div>
                    ...
                    <p1 class="p-2 text-gray-300 font-mono">Turbo NetScaler is a free toolkit, that I work on in my spare time.</p1> <br> <br>
                    <p1 class="p-2 text-gray-300 font-mono">PS: I'm a hobbyist developer and am always willing to get feedback</p1> <br> <br>
                    <p1 class="p-2 text-gray-300 font-mono">Much Love,</p1> <br>
                    <p1 class="p-2 text-gray-300 font-mono">Mick Hilhorst</p1>
                    <br> <br> <br>
